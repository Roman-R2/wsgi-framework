...
class R2Request:
    ...
    def parse_input_data(data: str):
        """ Replace data string to data dictionary. """
        result = {}
        if data:
            params = data.split('&')
            for item in params:
...
# get requests
class GetRequests(R2Request):

    @staticmethod
    def get_request_params(environ):
        """ Get data from wsqi QUERY_STRING and return data dictionary. """
